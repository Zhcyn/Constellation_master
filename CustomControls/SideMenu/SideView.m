...
{
    self.MenuNames = @[@"Horoscope",@"Zodic Characteristic",@"Share App",@"Rate US",@"More App"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        switch (indexPath.row)
        {
            ...
            case 2:
            {
                NSString *sharedMsg=[NSString stringWithFormat:@"https://itunes.apple.com/us/app/daily-horoscope-zodiac-sings/id1480923679?ls=1&mt=8"];
            ...
            case 3:
            {
                [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=1480923679&onlyLatestVersion=false&pageNumber=0&sortOrdering=1&type=Purple+Software"]] options:@{} completionHandler:nil];
                [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"Rate"];
                 break;
            }
            case 4:
            {
                [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://itunes.apple.com/us/developer/pankaj-bhalala/id1480923679"]] options:@{} completionHandler:nil];
                break;
            }
            default:
